...
### [2.1]Humdrum comprises two distinct aspects, corresponding to the representation
...
[3.4] Each encoded note in example 1 has at least two parts, corresponding
...
[3.5] The lower- or upper-case letters denote the pitch-class and octave of a
...
[3.6] As may be surmised, thoroughly encoding a piece of music can be a fairly
...
[3.7] While here is not the place for a detailed examination of all the various
...
[4.1] The “active” component of Humdrum, as compared to the “passive” syntax
...
[4.2] A glance at the names of most Humdrum commands reveals very little about
...
[5.1] In what proportion are leading-tones in Bach chorale melodies approached
...
[5.2] The original file represents notes by their pitch. We need scale-degree
...
[5.3] This is quite a messy file, for it includes comments (records with
...
[5.4] Notice that a few records with a minus sign appear in this file. These
...
[5.5] The original file has been whittled down to a series of records that
...
[5.6] The sequence of commands given above generated a chain of intermediate,
...
[5.7] As we can gather from the above, the difficulty in implementing the
...
[6.1] The manual divides the Toolkit into the categories of specialized and
...
[6.2] The “perform” command plays back the contents of a Humdrum MIDI file,
...
[6.3] Basic tools, contrary to specialized tools, do their work on any
...
[6.4] Two very powerful basic tools deserve special mention: “patt” and
...
[6.5] The demonstration program bundled with the Toolkit solves ten problems on
...
[6.6] The Toolkit and representation schemes are not intended to meet the
...
[7] Humdrum’s compendious reference manual is a model of clarity, completeness
...
[8.1] The Toolkit can currently be downloaded from the server at the University
...
[8.2] Scores that accompany the current release of Humdrum include a selection
...
[8.3] Huron is nearing completion of a Users’ Guide to Humdrum that “takes
...
[8.4] All this proselytizing may still fail to convince, given the reluctance
...
[8.5] Humdrum provides concrete answers to well-posed questions. Surprising or
...
[9.1] Appreciation of the full potential of Humdrum is definitely a hands-on
...
[9.2] Humdrum or other systems like it offer the wherewithal for a brand new
